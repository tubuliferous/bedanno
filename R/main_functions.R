...
library(devtools)
library(dplyr)
system.time(annotate_variants_with_intermediates("/Users/tubuliferous/Desktop/test/", "/Users/tubuliferous/Dropbox/gtex/transformed_data/bedified_genotypes.bed"))